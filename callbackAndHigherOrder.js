...
// CODE HERE
const multiply = (num1, num2, multiplication) => multiplication(num1 * num2);
...
// CODE HERE 
const first = (arr, callBackFunction) => callBackFunction(arr[0]);
...
// CODE HERE
const last = (arr, callBackFunction) => callBackFunction(arr[arr.length - 1]);
...
// CODE HERE 
const contains = (arr, name, callBackFunction) => {
...
// CODE HERE
const uniq = (arr, callBackFunction) => {
...
// CODE HERE 
//Using for of loop
//  const each = (arr, callbackFunction) => {
//    for (name of arr) {
//     callbackFunction(name, arr.indexOf(name));
//    }
//  }

//Using forEach method of arrays
const each = (arr, callbackFunction) => arr.forEach(callbackFunction);
...
console.log(`Add 3 to my favorite number 4: ${addFour(3)}`);